    ...
    return (
        <div className="ContactPage">
            ...
            <div className="contact-section">
                ...
                <ContactItem icon={email} title={"Email"} text1={"+00 214 147 0214"} text2={"+00 219 314 2147"} />
                <ContactItem icon={location} title={"Address"} text1={"+00 214 147 0214"} text2={"+00 219 314 2147"} />
            </div>
        </div>
    )
}
